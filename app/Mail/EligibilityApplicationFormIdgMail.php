...
class EligibilityApplicationFormIdgMail extends Mailable
{
    ...
    {
        return new Envelope(
//            subject: 'Confirmation of IDG EAF Submission - '.$this->institute,
    ...
    {
        return new Content(
            markdown: 'email.eligibilityApplicationFormIDG',
