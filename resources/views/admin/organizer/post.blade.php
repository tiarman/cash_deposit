              ...
              <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                ...
                @foreach($datas as $key => $val)
                  <tr class="@if(($key%2) == 0)gradeX @else gradeC @endif">
                    ...
                    <td class="p-1 text-capitalize"><button class="button-8" role="button">Post Details</button></td>
                    {{--                    <td class="p-1">{{ $val->start_date }}</td>--}}
                    <td class="p-1">{{ $val->created_at }}</td>
                ...
                {{--                    <a class="button-6" role="button">Post Details</a>--}}
                {{--                    <button class="button-8" role="button">Post Details</button>--}}
                {{--                    <a href="" class="btn btn-sm btn-success" style="cursor: pointer">Approve</a>--}}
                {{--                 </td>--}}
                {{--                  <td>10/11/22</td>--}}
                {{--                  <td class="text-center">--}}
                {{--                    <!-- HTML !-->--}}
                {{--                    <button class="button-8" role="button">Approve</button>--}}
                {{--                    <button class="button-8" role="button">Reject</button>--}}
  ...
  <script>
    $(document).ready(function () {
      ...
      $(document).on('change', 'input[name="onoffswitch"]', function () {
        ...
        $.ajax({
          url: "{{ route('admin.ajax.update.event.job.post.status') }}",
          method: "post",
          dataType: "html",
