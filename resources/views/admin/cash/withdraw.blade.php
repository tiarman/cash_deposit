...
{{--                                                                                    <a href="" class="brn btn-success btn-sm">New Agent</a>--}}
{{--                                                                                </div>--}}
{{--                                                                            </div>--}}
                                @endif
                                    <div class="table-rep-plugin">
                                        <div class="table-responsive mb-0" data-bs-pattern="priority-columns">
                                            <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%" style="font-size: 14px">
