                ...
                <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                  <a href="{{ route('admin.training.create') }}" class="brn btn-success btn-sm">New Training</a>
                            ...
                            <div class="table-responsive">
                                ...
                                <h5 class="my-4" >Total Value of Works Procurement : <span class="bg-info text-light p-2 rounded">780 Millions (TK.)</span></h5>
                            </div>
                        </div>
                    </section>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                  <a href="{{ route('admin.training.create') }}" class="brn btn-success btn-sm">New Training</a>
                            ...
                            <div class="table-responsive">
                                ...
                                <h5 class="my-4" >Total Value of Works Procurement : <span class="bg-info text-light p-2 rounded">810 Millions (TK.)</span></h5>
                            </div>
                        </div>
                    </section>
                </div>
