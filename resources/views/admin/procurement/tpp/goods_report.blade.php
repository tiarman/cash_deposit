                ...
                <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                  <a href="{{ route('admin.training.create') }}" class="brn btn-success btn-sm">New Training</a>
                            ...
                            <div class="app-report-heading-part row my-5">
                                ...
                                <div class="col-4">
                                    <h4 class="text-right ">Type : <span class="bg-success text-light p-2 rounded">GOODS</span></h4>
                            ...
                            <div class="table-responsive">
                                ...
                                <h5 class="my-4" >Total Value of Goods Procurement : <span class="bg-info text-light p-2 rounded">830 Millions (TK.)</span></h5>
                            </div>
                        </div>
                    </section>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                  <a href="{{ route('admin.training.create') }}" class="brn btn-success btn-sm">New Training</a>
                            ...
                            <div class="table-responsive">
                                ...
                                <h5 class="my-4" >Total Value of Goods Procurement : <span class="bg-info text-light p-2 rounded">840 Millions (TK.)</span></h5>
                            </div>
                        </div>
                    </section>
                </div>
