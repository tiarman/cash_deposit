        ...
        <div class="card-body">
          <section class="panel">
            <header class="panel-heading">
              <h2 class="panel-title">Rejected Training Members</h2>
            </header>
              ...
              @if(\App\Helper\CustomHelper::canView('Create Super Admin', 'Super Admin'))
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                    <a href="{{ route('admin.training.member.manage.pending') }}" class="brn btn-brown btn-sm">Pending List</a>
                  </div>
                </div>
              @endif
...
{{--                    <td class="p-1 ">{{ \App\Helper\CustomHelper::userRoleName($val) }}</td>--}}
                    ...
                    @if(\App\Helper\CustomHelper::canView('Manage Super Admin|Delete Super Admin', 'Super Admin'))
                      <td class="center hidden-phone p-1 text-center" width="200">
                        @if($val->status == \App\Models\User::$statusArrays[2])
                          ...
                          @if(\App\Helper\CustomHelper::canView('Manage Super Admin', 'Super Admin'))
                            <span class="btn btn-sm btn-primary btn-pending pending_{{ $val->id }}"
                                  style="cursor: pointer" data-id="{{ $val->id }}">Send to pending</span>
                          @endif
                        @endif
                      </td>
                    @endif
    ...
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 60%">
      <div class="modal-content">
        <div class="modal-header">
          <h4 style="font-size: 25px;" class="text-center">User Information</h4>
