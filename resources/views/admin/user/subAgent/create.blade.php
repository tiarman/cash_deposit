        ...
        <div class="card-body">
          <section class="panel">
            <header class="panel-heading">
              <h2 class="panel-title">Create new Sub-Agent</h2>
            </header>
            ...
            <div class="panel-body">
              ...
              <div class="row">
                <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                  <a href="{{ route('admin.user.list') }}" class="brn btn-success btn-sm">List of Sub-Agents</a>
                </div>
              </div>
              @endif
              ...
              <form action="{{ route('admin.subagent.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      <label class="control-label">Assign Agent<span class="text-danger">*</span></label>
                      <select name="agent_id" required class="form-control @error('role') is-invalid @enderror">
                        <option value="">Choose a Agent</option>
                        @foreach($agents as $agent)
                          <option value="{{ $agent->id }}"
                                  @if(old('role') == $agent->id) selected @endif>{{ ucfirst($agent->username) }}</option>
                                  @endforeach
                      </select>
                      @error('role')
