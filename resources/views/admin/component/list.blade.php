        ...
        <div class="card-body">
          <section class="panel">
            <header class="panel-heading">
              <h2 class="panel-title">Component list</h2>
            </header>
            <div class="panel-body">
              ...
              @if(\App\Helper\CustomHelper::canView('Create Component', 'Super Admin'))
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                    <a href="{{ route('admin.component.create') }}" class="brn btn-success btn-sm">New Component</a>
                  </div>
                </div>
              @endif
              <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                ...
                <tr>
                  ...
                  @if(\App\Helper\CustomHelper::canView('Manage Component|Delete Component', 'Super Admin'))
                  ...
                  <tr class="@if(($key%2) == 0)gradeX @else gradeC @endif">
                    ...
                    @if(\App\Helper\CustomHelper::canView('Manage Component|Delete Component', 'Super Admin'))
                      <td class="center hidden-phone p-1" width="100">
                          @if(\App\Helper\CustomHelper::canView('Manage Component', 'Super Admin'))
                            <a href="{{ route('admin.component.manage', [$val->id]) }}"
                               class="btn btn-sm btn-success"> <i class="fa fa-edit"></i> </a>
                          @endif
                          @if(\App\Helper\CustomHelper::canView('Delete Component', 'Super Admin'))
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <strong>Are you sure to delete this component?</strong>
        </div>
  ...
  <script>
    $(document).ready(function () {
      ...
      $(document).on('click', '.yes-btn', function () {
        ...
        $.ajax({
          url: "{{ route('admin.component.destroy') }}",
          method: "DELETE",
          dataType: "html",
          data: {id: pid},
          success: function (data) {
