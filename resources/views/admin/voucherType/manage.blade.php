        ...
        <div class="card-body">
          <section class="panel">
            <header class="panel-heading">
              <h2 class="panel-title">Manage Voucher Types</h2>
            </header>
            <div class="panel-body">
              ...
              <form action="{{ route('admin.voucher.type.store') }}" method="post">
                @csrf
                <input type="hidden" class="dt form-control" name="id" value="{{ $voucherType->id }}">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="control-label">Short Name</label>
                            <input type="text" min="0" name="short_name" placeholder="Short Name" autocomplete="off"
                                   value="{{ old('short_name' , $voucherType->short_name)}}"
