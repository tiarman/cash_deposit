              ...
              @if(\App\Helper\CustomHelper::canView('Create Institute User', 'Super Admin'))
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                    <a href="{{ route('admin.institute.head.approved') }}" class="brn btn-primary btn-sm">Accepted List</a>
                    <a href="{{ route('admin.institute.head.rejected') }}" class="brn btn-secondary btn-sm">Rejected List</a>
                  </div>
                </div>
              @endif
