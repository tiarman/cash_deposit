        ...
        <div class="card-body">
          <section class="panel">
            <header class="panel-heading">
              <h2 class="panel-title">Create Teacher</h2>
            </header>
            <div class="panel-body">
              ...
              <form action="{{ route('admin.institute.head.teacher.create') }}" method="post">
                @csrf
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      <label class="control-label">Department/Technology/Trade<span class="text-danger">*</span></label>
                      <select name="department" required class="form-control @error('department') is-invalid @enderror">
                        <option value="">Choose a department</option>
                        @foreach($departments as $department)
                          <option value="{{ $department->id }}"
                                  @if(old('department_id') == $department->id) selected @endif>{{ ucfirst($department->name) }}</option>
                        @endforeach
                      </select>
                      @error('department')
