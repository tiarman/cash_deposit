              ...
              @if(\App\Helper\CustomHelper::canView('Create Institute User', 'Super Admin'))
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                    <a href="{{ route('admin.institute.head.teacher.create') }}" class="brn btn-success btn-sm">New Teacher</a>
                  </div>
                </div>
              @endif
              <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                ...
                @foreach($datas as $key => $val)
                  <tr class="@if(($key%2) == 0)gradeX @else gradeC @endif">
                    ...
                    <td class="p-1">{{ $val->department?->name }}</td>
...
{{--                          @if(\App\Helper\CustomHelper::canView('Manage Institute User', 'Super Admin'))--}}
{{--                            <a href="{{ route('admin.institute.head.manage', [$val->id]) }}"--}}
