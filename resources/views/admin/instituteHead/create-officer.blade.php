        ...
        <div class="card-body">
          <section class="panel">
            <header class="panel-heading">
              <h2 class="panel-title">Create Officer</h2>
            </header>
            <div class="panel-body">
              @if(\App\Helper\CustomHelper::canView('List Of Institute', 'Super Admin'))
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                    <a href="{{ route('admin.institute.head.officer.list') }}" class="brn btn-success btn-sm">List of Officers</a>
                  </div>
                </div>
              @endif
              ...
              <form action="{{ route('admin.institute.head.officer.create') }}" method="post">
                @csrf
