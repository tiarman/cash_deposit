                ...
                <div class="card-body">
                    <section class="panel">
                        <header class="panel-heading">
                            <h2 class="panel-title">Fiscal Period list</h2>
                        </header>
                            ...
                            @if(\App\Helper\CustomHelper::canView('Create Fiscal Period', 'Super Admin'))
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                                        <a href="{{ route('admin.fiscalPeriod.create') }}" class="brn btn-success btn-sm">New Fiscal Period</a>
                                    </div>
                                </div>
                            @endif
                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                @foreach($datas as $key => $val)
                                    <tr class="@if(($key%2) == 0)gradeX @else gradeC @endif">
                                        ...
                                        <td class="p-1 text-capitalize">{{ \App\Models\FiscalYear::where('id',$val->fiscal_year_id)->pluck('code')->first() }}</td>
