        ...
        <div class="card-body">
          <section class="panel">
            <header class="panel-heading">
              <h2 class="panel-title">Create Technology</h2>
            </header>
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label class="control-label">Technology Name<span class="text-danger">*</span></label>
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-body">
          <section class="panel">
            <header class="panel-heading">
              <h2 class="panel-title">Technology list</h2>
            </header>
            <div class="panel-body">
              @if(session()->has('status'))
                {!! session()->get('status') !!}
                  ...
                  <tr class="@if(($key%2) == 0)gradeX @else gradeC @endif">
                    ...
                    @if(\App\Helper\CustomHelper::canView('Manage Technology|Delete Technology', 'Super Admin'))
                      <td class="center hidden-phone p-1" width="100">
                          @if(\App\Helper\CustomHelper::canView('Manage Technology', 'Super Admin'))
                          ...
                          @endif
                          @if(\App\Helper\CustomHelper::canView('Delete Technology', 'Super Admin'))
